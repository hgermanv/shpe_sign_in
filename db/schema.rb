...
ActiveRecord::Schema[7.1].define(version: 2024_07_24_222801) do
  ...
  create_table "event_attendances", force: :cascade do |t|
    ...
    t.index ["student_id"], name: "index_event_attendances_on_student_id"
  end
  ...
  add_foreign_key "event_attendances", "students"
end
